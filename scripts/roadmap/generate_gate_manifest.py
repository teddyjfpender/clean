...
CORE_GATES: List[str] = [
    ...
    "scripts/roadmap/check_rgr_deliverables.sh",
    ...
    "scripts/test/rgr_deliverables_negative.sh",
    "scripts/test/rgr_loop_smoke.sh",
    "scripts/test/rgr_status_transition_negative.sh",
