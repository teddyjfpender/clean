...
"$ROOT_DIR/scripts/roadmap/check_gate_manifest_sync.sh"
"$ROOT_DIR/scripts/roadmap/check_gate_sharding_pipeline.sh"
"$ROOT_DIR/scripts/roadmap/check_capability_registry.sh"
"$ROOT_DIR/scripts/roadmap/check_capability_obligations.sh"
...
"$ROOT_DIR/scripts/roadmap/check_baseline_provenance.sh"
"$ROOT_DIR/scripts/roadmap/check_differential_harness_sync.sh"
"$ROOT_DIR/scripts/roadmap/check_benchmark_harness_sync.sh"
"$ROOT_DIR/scripts/roadmap/check_corpus_coverage_report_sync.sh"
"$ROOT_DIR/scripts/roadmap/check_corpus_coverage_trend_sync.sh"
"$ROOT_DIR/scripts/roadmap/check_profile_artifacts_freshness.sh"
"$ROOT_DIR/scripts/roadmap/check_cost_model_calibration_freshness.sh"
"$ROOT_DIR/scripts/roadmap/check_corelib_parity_freshness.sh"
"$ROOT_DIR/scripts/roadmap/check_corelib_parity_trend.sh"
...
"$ROOT_DIR/scripts/roadmap/check_optimization_closure_report.sh"
"$ROOT_DIR/scripts/roadmap/check_completion_matrix.sh"
"$ROOT_DIR/scripts/roadmap/check_track_a_completion_audit.sh"
"$ROOT_DIR/scripts/roadmap/check_track_b_completion_audit.sh"
"$ROOT_DIR/scripts/roadmap/check_completion_certificate.sh"
"$ROOT_DIR/scripts/roadmap/check_rgr_deliverables.sh"
"$ROOT_DIR/scripts/roadmap/check_release_reports_freshness.sh"
"$ROOT_DIR/scripts/roadmap/check_release_go_no_go.sh"
...
"$ROOT_DIR/scripts/roadmap/check_effect_metadata.sh"
...
"$ROOT_DIR/scripts/test/eval_conversion_legality.sh"
"$ROOT_DIR/scripts/test/eval_aggregate_wrapper_semantics.sh"
"$ROOT_DIR/scripts/test/eval_typed_resource_mixed.sh"
"$ROOT_DIR/scripts/test/control_flow_normalization_regression.sh"
"$ROOT_DIR/scripts/test/call_panic_semantics_regression.sh"
"$ROOT_DIR/scripts/test/canonicalization_regression.sh"
"$ROOT_DIR/scripts/test/optimizer_pass_regression.sh"
"$ROOT_DIR/scripts/test/optimizer_contracts_regression.sh"
"$ROOT_DIR/scripts/test/proof_obligations_negative.sh"
"$ROOT_DIR/scripts/test/proof_debt_policy_negative.sh"
"$ROOT_DIR/scripts/test/effect_metadata_negative.sh"
"$ROOT_DIR/scripts/test/release_go_no_go_negative.sh"
"$ROOT_DIR/scripts/test/gate_manifest_reproducibility.sh"
"$ROOT_DIR/scripts/test/gate_manifest_negative.sh"
"$ROOT_DIR/scripts/test/gate_sharding_reproducibility.sh"
"$ROOT_DIR/scripts/test/gate_shard_aggregation_reproducibility.sh"
"$ROOT_DIR/scripts/test/gate_retry_determinism.sh"
"$ROOT_DIR/scripts/test/capability_registry_negative.sh"
"$ROOT_DIR/scripts/test/capability_obligations_reproducibility.sh"
"$ROOT_DIR/scripts/test/capability_obligations_negative.sh"
...
"$ROOT_DIR/scripts/test/baseline_sync_reproducibility.sh"
"$ROOT_DIR/scripts/test/baseline_provenance_negative.sh"
...
"$ROOT_DIR/scripts/test/benchmark_harness_reproducibility.sh"
"$ROOT_DIR/scripts/test/benchmark_family_thresholds_negative.sh"
"$ROOT_DIR/scripts/test/profile_artifacts_reproducibility.sh"
"$ROOT_DIR/scripts/test/profile_artifacts_negative.sh"
"$ROOT_DIR/scripts/test/cost_model_calibration_reproducibility.sh"
"$ROOT_DIR/scripts/test/cost_model_calibration_negative.sh"
"$ROOT_DIR/scripts/test/corpus_coverage_reproducibility.sh"
"$ROOT_DIR/scripts/test/corpus_coverage_trend_reproducibility.sh"
"$ROOT_DIR/scripts/test/corpus_coverage_negative.sh"
"$ROOT_DIR/scripts/bench/generated/run_manifest_benchmarks.sh"
"$ROOT_DIR/scripts/test/rgr_deliverables_negative.sh"
"$ROOT_DIR/scripts/test/rgr_loop_smoke.sh"
"$ROOT_DIR/scripts/test/rgr_status_transition_negative.sh"
...
"$ROOT_DIR/scripts/test/cairo_ast_idempotence.sh"
"$ROOT_DIR/scripts/test/backend_parity.sh"
...
"$ROOT_DIR/scripts/test/sierra_review_lift_complex.sh"
...
"$ROOT_DIR/scripts/test/sierra_sq128x128_typed_differential.sh"
"$ROOT_DIR/scripts/test/sierra_aggregate_collection_e2e.sh"
"$ROOT_DIR/scripts/test/sierra_advanced_family_e2e.sh"
"$ROOT_DIR/scripts/test/sierra_aggregate_branch_typing.sh"
