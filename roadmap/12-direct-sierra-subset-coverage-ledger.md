...
4. Remaining blocker: checked/panic result typing for integer families is still not modeled in Lean IR/backend, and `mulU128` plus non-`u128` families remain fail-fast.
