...
pub trait ISQ128x128TypedLaneContract<TContractState> {
    ...
    fn sq128x128_add_raw_i16(self: @TContractState, a_lane: i16, b_lane: i16) -> i16;
    fn sq128x128_sub_raw_i16(self: @TContractState, a_lane: i16, b_lane: i16) -> i16;
    fn sq128x128_mul_raw_i16(self: @TContractState, a_lane: i16, b_lane: i16) -> i16;
    fn sq128x128_delta_raw_i16(self: @TContractState, a_lane: i16, b_lane: i16) -> i16;
    fn sq128x128_affine_kernel_i16(self: @TContractState, a_lane: i16, b_lane: i16, c_lane: i16, d_lane: i16, e_lane: i16) -> i16;
}
...
mod SQ128x128TypedLaneContract {
    ...
    impl SQ128x128TypedLaneContractImpl of super::ISQ128x128TypedLaneContract<ContractState> {
        ...
        fn sq128x128_add_raw_i16(self: @ContractState, a_lane: i16, b_lane: i16) -> i16 {
            (a_lane + b_lane)
        }

        fn sq128x128_sub_raw_i16(self: @ContractState, a_lane: i16, b_lane: i16) -> i16 {
            (a_lane - b_lane)
        }

        fn sq128x128_mul_raw_i16(self: @ContractState, a_lane: i16, b_lane: i16) -> i16 {
            (a_lane * b_lane)
        }

        fn sq128x128_delta_raw_i16(self: @ContractState, a_lane: i16, b_lane: i16) -> i16 {
            (b_lane - a_lane)
        }

        fn sq128x128_affine_kernel_i16(self: @ContractState, a_lane: i16, b_lane: i16, c_lane: i16, d_lane: i16, e_lane: i16) -> i16 {
            {
